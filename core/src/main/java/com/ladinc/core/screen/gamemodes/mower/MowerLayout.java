...
public class MowerLayout extends GenericLayout
{
	...
	public void createWorld(World world) 
	{
		...
		new BoxProp(world, TILE_SIZE, getWorldHeight(), new Vector2 (getWorldWidth()/2, getWorldHeight()/2));
	...
	private void createHomeTiles(World world)
	{
		...
		for(int i = 0; i < 8; i++)
		{
			...
			for(int j = 0; j < 9; j++)
			{
				...
				FloorTileSensor tempFTS = new FloorTileSensor(world, TILE_SIZE, TILE_SIZE, new Vector2(tempX, tempY));
