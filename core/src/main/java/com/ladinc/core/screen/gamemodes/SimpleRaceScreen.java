...
import com.ladinc.core.screen.gamemodes.mazes.SimpleMaze;
import com.ladinc.core.vehicles.Car;
import com.ladinc.core.vehicles.Vehicle;

public class SimpleRaceScreen extends GameScreen implements Screen 
{
	...
	private void createCarsForPlayers()
	{
		...
		for( int i = 0; i < this.game.controllerManager.players.size(); i++)
		{
			...
			tempCar = new Car(	tempPlayer, 
								this.world, 
								this.maze.getPlayerStartPoint(tempPlayer.team),
								null,
								null);
