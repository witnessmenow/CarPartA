...
call "%JAVA_HOME%/bin/java" -jar desktop/target/carparta-desktop-1.0-SNAPSHOT-jar-with-dependencies.jar
pause
GOTO start
...
xcopy "desktop/target/carparta-desktop-1.0-SNAPSHOT-jar-with-dependencies.jar" game
pause
GOTO start
